                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"  style="margin-right:5px;"></i></span>
                                                <input type="email" class="form-control"   id="id" name="id" placeholder="Enter your Email" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"  style="margin-right:5px;"></i></span>
                                ...
                                <input type="submit" name="log"  value="Log in" class="btn btn-primary"  style="margin-top:20px; background:pink; border:none; margin-left:15px;" /></div>
                                    <h2><?php echo $err;?></h2>
                                    <div class="register" style="margin-bottom:20px; " >
                                        <a href="register.php" style="text-decoration:none; color:pink; margin-left:10px; ">Register</a>
                                    </div>
                                </form>
                            </div>
