...
font-family: 'Lora', serif;">
    ...
    <div id="tooplate_main" style="margin-left:40px; margin-top:20px;">
    	
      <h2><span>Thank you for shopping with us</span></h2>
          <p><font color="pink"><i>Order sent successfully!</i></font></p>
		  <p>Your order no. is <?php echo "<font size='4' color='pink'>".$_REQUEST['order_no']."</font>";?></p>
		  <p>Thank you. Please come again.</p>
		  <br><br>
		  <p><a href="?log=out" style="color:pink; text-decoration:none;">Log out</a></p> 
