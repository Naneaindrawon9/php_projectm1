...
font-family: 'Lora', serif;">
    ...
    <div class="banner-container">
        <div class="banner">
            <div class="skincare">
            <img src="product/png2 (2).png"></div>
        <div class="content">
            <spam>Choose your scent festival</spam>
            <h3>November 11 , 11:00 AM, Novotel Hotel </h3>
            <p> Invite all of our customers to celebrate our new fragances collection together</p>
            
            

        </div>
        <div class="women">
            <img src="product/png2 (1).png">
        </div>
        </div>
   ...
   echo "
   <td height='400' width='250' align='center'><div style='border:solid 1px grey; border-radius:10px; margin-left:150px;'><img src='admin/image/$i' height='200' width='200' style='border-radius:10px;'><br/>".$arr['prod_no'].
   "<br><b></b>&nbsp;".$arr['price'].
  "<br><hr><div style='margin-bottom:10px;'><a href='login.php?img=$i' style='text-decoration:none; color:pink;'><b>Buy</b></a></div></div>
